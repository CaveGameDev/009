<script lang="ts">
	...
	const pathJarLibs = `${pathJarLaunchWrapper}:/app/asm-all-4.1.jar:/app/jopt-simple-4.5.jar:/app/log4j-api-2.0-beta9.jar:/app/log4j-core-2.0-beta9.jar:/app/lwjgl/lwjgl-2.9.3.jar:/app/lwjgl/lwjgl_util-2.9.3.jar:/app/guava-18.0.jar:/app/authlib-1.5.21.jar:${pathJarMinecraft}`;
