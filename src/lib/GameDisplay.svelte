<script lang="ts">
	...
	const pathJarMinecraft = "/app/c0.0.14a_08.jar"; 
	...
	const pathJarLibs = `/app/launchwrapper-1.6.jar:/app/asm-all-4.1.jar:/app/jopt-simple-4.5.jar:/app/lwjgl/lwjgl-2.9.3.jar:/app/lwjgl/lwjgl_util-2.9.3.jar:${pathJarMinecraft}`;
