<script lang="ts">
	...
	const pathJarLibs = `/app/lwjgl-assimp-natives-linux.jar:/app/lwjgl-natives-linux.jar:/app/lwjgl.jar:/app/lwjgl-javadoc.jar:lwjgl-sources.jar:${pathJarMinecraft}`;
