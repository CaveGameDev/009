<script lang="ts">
	...
	const pathJarMinecraft = "/app/a1.0.16_02.jar"; 
	...
	const pathJarLibs = `${pathJarLaunchWrapper}:/app/asm-all-4.1.jar:/app/jopt-simple-4.5.jar:/app/lwjgl/lwjgl-2.9.3.jar:/app/lwjgl/lwjgl_util-2.9.3.jar:/app/soundsystem-20120107.jar:${pathJarMinecraft}`;
	...
	async function startCheerpJ() {
		await cheerpjInit({
			...
			libraries: {
  			"libGL.so.1": "/app/lwjgl/libraries/gl4es.wasm",
