<script lang="ts">
	...
	const pathJarMinecraft = "/app/versions/1.7.10.jar";
	...
	async function startGame() {
		...
		await cheerpjRunMain(
			"JSMC.Twitch.Main",
			pathJarLibs,
			"--type", "2", // Changed: Flag and value are now separate arguments
		);
	}
