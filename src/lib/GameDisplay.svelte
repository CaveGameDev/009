<script lang="ts">
	...
	const pathJarMinecraft = "/app/obf.jar";
	const pathJarLaunchWrapper = "/app/launchwrapper-1.6.jar";
	const pathJarLibs = `/app/INF_PLUS_IntJar.jar:${pathJarLaunchWrapper}:/app/asm-all-4.1.jar:/app/jopt-simple-4.5.jar:/app/lwjgl/LWJGL-Jinput.jar:/app/lwjgl/lwjgl_util-2.9.3.jar:${pathJarMinecraft}`;
