<script lang="ts">
	...
	const pathJarMinecraft = "/app/a1.0.6-02.jar"; 
	...
	const pathJarLibs = `${pathJarLaunchWrapper}:/app/InterceptingJar.jar:/app/asm-all-4.1.jar:/app/jopt-simple-4.5.jar:/app/lwjgl/lwjgl-2.9.3.jar:/app/lwjgl/lwjgl_util-2.9.3.jar:${pathJarMinecraft}`;
	...
	async function startGame() {
		...
		tryPlausible("Play");
		// Use com.STG.Interceptingjar as the main class,
		// and pass the tweakClass as a program argument.
		await cheerpjRunMain(
			"com.STG.Interceptingjar",
			pathJarLibs,
